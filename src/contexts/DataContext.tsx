...
export const DataProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const fetchItemTypes = async (force = false) => {
    ...
    try {
      const response = await fetch('http://localhost:3001/api/designs/item-types', {
  ...
  const fetchColors = async (force = false) => {
    ...
    try {
      const response = await fetch('http://localhost:3001/api/designs/colors', {
        headers: { 'Authorization': `Bearer ${token}` },
      });
  ...
  const fetchParties = async (force = false) => {
    ...
    try {
      const response = await fetch('http://localhost:3001/api/orders/parties', {
        headers: { 'Authorization': `Bearer ${token}` },
      });
  ...
  const fetchDesigns = async (force = false) => {
    ...
    try {
      const response = await fetch('http://localhost:3001/api/orders/designs', {
        headers: { 'Authorization': `Bearer ${token}` },
      });
  ...
  const fetchTransport = async (force = false) => {
    ...
    try {
      const response = await fetch('http://localhost:3001/api/orders/transport', {
        headers: { 'Authorization': `Bearer ${token}` },
      });
